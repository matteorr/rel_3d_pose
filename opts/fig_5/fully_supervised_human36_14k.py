...
opt.data_dir   = '/home/mronchi/Storage/Datasets/human3.6/h5_annotations' #'../../h5_annotations'

# save path for experiments and experiment name
opt.ckpt = '../checkpoint/fig_5'
opt.exp  = 'fully_supervised_human36_14k'
...
opt.limb_type = None # 'avg_human36' 'avg_human36', 'avg_person'
