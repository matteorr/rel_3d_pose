...
checkpoint_dir = '../checkpoint/fig_4c_train_test_noise'
...
for i, n in enumerate(test_amount_noise):
    ...
    if n != 'detections':
        exp_opt.train_noise_type_2d   = 'normal'
        exp_opt.train_noise_amount_2d = n
        exp_opt.test_noise_type_2d   = 'normal'
        exp_opt.test_noise_amount_2d = n
    else:
        exp_opt.dataset_type         = 'shg_16k'
        exp_opt.train_noise_type_2d   = n
        exp_opt.train_noise_amount_2d = 0
...
with open('%s/fig_4c_train_test_noise_results.json'%(checkpoint_dir),'w') as fp:
